...
class CourseViewSet(viewsets.ModelViewSet):
    ...
    def intro(self, request, pk=None):
        ...
        Returns the welcoming note and upcoming modules list generated by LLM.
        """
        course = self.get_object()
        modules = course.modules.all()
        from .llm import generate_course_intro_overview
        intro_content = generate_course_intro_overview(course.title, course.description, modules)
